...
def localAlign(text1Path,text2Path,resultsPath,newResultsPath,padRatio):
	...
	with open(resultsPath, 'rb') as f:        
		...
		for row in reader:
			...
			allLines.append([startOne + newStartOne, startTwo + newStartTwo, startOne + newEndOne, startTwo + newEndTwo, -1*score])
			orgId = orgId + 1
