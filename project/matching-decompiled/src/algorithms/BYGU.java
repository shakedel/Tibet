...
public class BYGU {
   ...
   public BYGU(SuffixTreeNode tree1, SuffixTreeNode tree2, String seq1, String terminator1, String seq2, String terminator2, int maxDiff, int minLen) {
      this._tree1 = tree1;
      this._tree2 = tree2;
   ...
   private void fillTableForChild1Child2(SuffixTreeNode curr1, SuffixTreeNode curr2) {
      ...
      int[][] cornerVals = (int[][])this._previousResults[prevI][prevJ];
      int[][] leftVals = (int[][])this._previousResults[currI][prevJ];
      int[][] upperVals = (int[][])this._previousResults[prevI][currJ];
      int i;
   ...
   public static void main(String[] args) {
      ...
      BYGU var35 = new BYGU(tree1, tree2, seq1, terminator1, seq2, terminator2, maxDiff, minLen);
