...
public class BYGUInteger {
   ...
   public BYGUInteger(SuffixTreeNode tree1, SuffixTreeNode tree2, String seq1, String terminator1, String seq2, String terminator2, int maxDiff, int minLen) {
      this._tree1 = tree1;
      this._tree2 = tree2;
   ...
   private void processSubtrees(SuffixTreeNode root1, SuffixTreeNode root2) {
      if(!this.freeEnds || this._seq1[root1.labelStart] == this._seq2[root2.labelStart]) {
         this._previousResults = new Object[root1.totalChildren][root2.totalChildren];
         this._monitor = new boolean[root1.totalChildren][root2.totalChildren];
   ...
   private void fillTableForChild1Child2(SuffixTreeNode curr1, SuffixTreeNode curr2) {
      ...
      Integer[][] cornerVals = (Integer[][])this._previousResults[prevI][prevJ];
      Integer[][] leftVals = (Integer[][])this._previousResults[currI][prevJ];
      Integer[][] upperVals = (Integer[][])this._previousResults[prevI][currJ];
      int i;
      if(this._monitor[prevI][prevJ]) {
         this._table = new Integer[this._maxLength + 2][this._maxLength + 2];
         ...
         Integer[] prevrowheader = leftVals[0];
         Integer[] prevcolheader = upperVals[1];
         Integer[] prevlastRowVals = upperVals[2];
         Integer[] prevlastColVals = leftVals[3];
         int allLeaves1 = 2;
         ...
         for(rowHeader = i + 1; tableToSave <= lastRow; ++rowHeader) {
            for(colHeader = general.Utils.max(curr2children + 1, rowHeader - this._maxDiff); colHeader <= general.Utils.min(curr2child, rowHeader + this._maxDiff); ++colHeader) {
               this._table[tableToSave][colHeader] = new Integer(general.Utils.min(this._table[tableToSave - 1][colHeader - 1].intValue() + edScore(this._seq1[this._table[tableToSave][0].intValue()], this._seq2[this._table[0][colHeader].intValue()]), this.infinity(this._table[tableToSave][colHeader - 1]) + 1, this.infinity(this._table[tableToSave - 1][colHeader]) + 1));
               if(this._produceOutput && tableToSave - 1 >= this._minLength && colHeader - 1 >= this._minLength && this._table[tableToSave][colHeader].intValue() <= this._maxDiff && this._seq1[this._table[tableToSave][0].intValue()] != this._terminator1 && this._seq2[this._table[0][colHeader].intValue()] != this._terminator2) {
         ...
         Integer[][] var33 = new Integer[4][];
         Integer[] var34 = new Integer[lastRow - 1];
         ...
         var33[0] = var34;
         Integer[] var35 = new Integer[curr2child - 1];
         ...
         var33[1] = var35;
         Integer[] var36 = new Integer[curr2child - 1];
         Integer[] leftprevlastRowVals = leftVals[2];
         ...
         var33[2] = var36;
         Integer[] var37 = new Integer[lastRow - 1];
         Integer[] upperprevlastColVals = upperVals[3];
         ...
         var33[3] = var37;
         this._previousResults[curr1.orderNumber][curr2.orderNumber] = var33;
         this._monitor[curr1.orderNumber][curr2.orderNumber] = continuecompare;
      }
   ...
   private void fillTableForChild1Root2(SuffixTreeNode curr1, SuffixTreeNode root2) {
      byte prevJ = 0;
      int prevI = curr1.parentOrderNumber;
      Integer[][] prevValues = (Integer[][])this._previousResults[prevI][prevJ];
      if(this._monitor[prevI][prevJ]) {
         Integer[] prevrowheader = prevValues[0];
         Integer[] prevcolheader = prevValues[1];
         Integer[] prevlastRowVals = prevValues[2];
         Integer[] prevlastColVals = prevValues[3];
         ...
         this._table = new Integer[general.Utils.min(this._maxLength + 2, lastRow + 1)][general.Utils.min(this._maxLength + 2, prevlastCol + 1)];
         int allLeaves1 = 2;
         ...
         for(allLeaves1 = prevlastRow; allLeaves1 <= lastRow; ++allLeaves1) {
            this._table[allLeaves1][1] = new Integer(allLeaves1 - 1);
         }
         ...
         for(tableToSave = prevlastRow + 1; tableToSave <= lastRow; ++pos) {
            this._table[tableToSave][0] = new Integer(pos);
            ++tableToSave;
         }
         ...
         Integer[][] var26 = new Integer[4][];
         Integer[] var27 = new Integer[lastRow - 1];
         ...
         var26[0] = var27;
         Integer[] var29 = new Integer[lastCol - 1];
         ...
         var26[1] = var29;
         boolean var28 = false;
         Integer[] lastRowVals = new Integer[lastCol - 1];
         ...
         var26[2] = lastRowVals;
         Integer[] var30 = new Integer[lastRow - 1];
         ...
         var26[3] = var30;
         this._previousResults[curr1.orderNumber][0] = var26;
         this._monitor[curr1.orderNumber][0] = var28;
      }
   ...
   private void fillTableForRoot1Children2(SuffixTreeNode root1, List children2) {
      for(int c = 0; c < children2.size(); ++c) {
         ...
         byte prevI = 0;
         Integer[][] prevValues = (Integer[][])this._previousResults[prevI][prevJ];
         if(this._monitor[0][prevJ]) {
            Integer[] grandchildren = prevValues[0];
            Integer[] prevcolheader = prevValues[1];
            Integer[] prevlastRowVals = prevValues[2];
            Integer[] prevlastColVals = prevValues[3];
            this._table = new Integer[this._maxLength + 2][this._maxLength + 2];
            ...
            for(allLeaves1 = prevlastCol; allLeaves1 <= lastCol; ++allLeaves1) {
               this._table[1][allLeaves1] = new Integer(allLeaves1 - 1);
            }
            ...
            for(tableToSave = prevlastCol + 1; tableToSave <= lastCol; ++pos) {
               this._table[0][tableToSave] = new Integer(pos);
               ++tableToSave;
            }
            ...
            var29[0] = var30;
            Integer[] var31 = new Integer[lastCol - 1];
            ...
            var29[2] = lastRowVals;
            Integer[] var33 = new Integer[lastRow - 1];
            ...
            var29[3] = var33;
            this._previousResults[0][child2.orderNumber] = var29;
            this._monitor[0][child2.orderNumber] = var32;
         }
   ...
   private int infinity(Integer val) {
      return val == null?this.INFINITY:val.intValue();
   }
   ...
   private void fillTableForRoots(SuffixTreeNode root1, SuffixTreeNode root2) {
      ...
      for(allLeaves1 = 2; allLeaves1 <= lastRow; ++pos) {
         this._table[allLeaves1][0] = new Integer(pos);
         ++allLeaves1;
      }
      ...
      for(allLeaves1 = 2; allLeaves1 <= lastCol; ++pos) {
         this._table[0][allLeaves1] = new Integer(pos);
         ++allLeaves1;
      }
      ...
      int tableToSave;
      for(tableToSave = 1; tableToSave <= lastRow; ++tableToSave) {
         this._table[tableToSave][1] = new Integer(tableToSave - 1);
      }

      for(tableToSave = 1; tableToSave <= lastCol; ++tableToSave) {
         this._table[1][tableToSave] = new Integer(tableToSave - 1);
      }
      ...
      for(int rowHeader = 2; tableToSave <= lastRow; ++rowHeader) {
         for(colHeader = general.Utils.max(2, rowHeader - this._maxDiff); colHeader <= general.Utils.min(lastCol, rowHeader + this._maxDiff); ++colHeader) {
            this._table[tableToSave][colHeader] = new Integer(general.Utils.min(this._table[tableToSave - 1][colHeader - 1].intValue() + edScore(this._seq1[this._table[tableToSave][0].intValue()], this._seq2[this._table[0][colHeader].intValue()]), this.infinity(this._table[tableToSave][colHeader - 1]) + 1, this.infinity(this._table[tableToSave - 1][colHeader]) + 1));
            if(tableToSave - 1 >= this._minLength && colHeader - 1 >= this._minLength && this._table[tableToSave][colHeader].intValue() <= this._maxDiff && this._seq1[this._table[tableToSave][0].intValue()] != this._terminator1 && this._seq2[this._table[0][colHeader].intValue()] != this._terminator2) {
      ...
      Integer[] var16 = new Integer[lastRow - 1];
      ...
      var17[0] = var16;
      Integer[] var18 = new Integer[lastCol - 1];
      ...
      var17[2] = lastRowVals;
      Integer[] var20 = new Integer[lastRow - 1];
      ...
      var17[3] = var20;
      this._previousResults[0][0] = var17;
      this._monitor[0][0] = var19;
   }
   ...
   private void addToSolution(List positions1, List positions2, int len1, int len2) {
      for(int i = 0; i < positions1.size(); ++i) {
         ...
         for(int j = 0; j < positions2.size(); ++j) {
            ...
            if(this.freeEnds && this._seq1[startI] == this._seq2[startJ] && this._seq1[endI] == this._seq2[endJ] && this._table[len1][len2].intValue() <= general.Utils.min(this.infinity(this._table[len1 + 1][len2]), this.infinity(this._table[len1][len2 + 1])) + 1 || !this.freeEnds) {
   ...
   public static void main(String[] args) {
      ...
      BYGUInteger var35 = new BYGUInteger(tree1, tree2, seq1, terminator1, seq2, terminator2, maxDiff, minLen);
