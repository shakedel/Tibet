...
import tau.cs.wolf.tibet.percentage_apbt.misc.LevenshteinDistanceGeneric;
import tau.cs.wolf.tibet.percentage_apbt.misc.PropsBuilder.Props;
import tau.cs.wolf.tibet.percentage_apbt.misc.Utils;

public class WorkerThreadGeneric<R extends Slicable<R>> extends BaseModule implements Runnable {
	...
	public WorkerThreadGeneric(Props props, Args args, R seq1, R seq2, Interval workInterval, MatchesContainer rContainer, int threadId) {
		super(props, args);
	...
	public void run() {
		...
		Apbt<R> apbt = Utils.newApbt(props.getApbtClass());
		...
		for(Interval curSolution: apbt.getMaximalSolutions()) {
			...
			double score = LevenshteinDistanceGeneric.computeLevenshteinDistance(seq1Slice, seq2Slice);
