...
public final class UniqueFilePairFilter implements Function<FileContentPair, Boolean>, Serializable {
	private static final long serialVersionUID = 1L;

	private Logger logger = LoggerFactory.getLogger(getClass());
	
	@Override
	public Boolean call(FileContentPair fileContentPair) throws Exception {
